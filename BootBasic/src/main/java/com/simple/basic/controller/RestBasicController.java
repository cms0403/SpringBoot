...
public class RestBasicController {
	...
	//jackson-databind라이브러리 필수( 부트에는 기본으로 라이브러리를 가지고 있습니다)
	...
	//@CrossOrigin("*")
//	@CrossOrigin("http://127.0.0.1:5501") //post방식은 ip:port가 동일해야 요청을 허용하는데, 서버가 다르다면 특정서버의 요청을 허용해야 요청처리를 받을수 있습니다.
